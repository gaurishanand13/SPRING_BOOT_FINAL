...
public class Streams {
    ...
    public static void main(String[] args) {
         ...
         * map helps in updating the value if need for the stream
         * forEach is useful in performing some operation on each object of stream if reqd.
         */
        ...
        // Output for above is - X = 8 ,X = 10 ,100 X = 12 ,X = 20 ,400 X = 30 ,900 X = 40 ,1600
        ...
        // You are given an arr of integers, you have to calculate the sum of squares of even no. Note here identity = 1 is the starting value while running the loop and after that it will be 1 + arr[0] + arr[1] + ...
