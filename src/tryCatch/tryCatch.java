...
//            person = new Person(); // instead of declaring it here, if we declare in try catch prototype, then if the object declared implements close function. it will be executed automatically.
